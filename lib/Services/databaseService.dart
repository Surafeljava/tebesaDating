...
class DatabaseService with ChangeNotifier {
  ...
  Future<List<BankDetail>> getAllPaymentOptions() async {
    List<BankDetail> bankDetails = [];
    var result = await firestoreInstance.collection('bankInfo').get();
    result.docs.forEach((element) {
      bankDetails.add(BankDetail.fromMap(element.data()));
    });
    return bankDetails;
  }
