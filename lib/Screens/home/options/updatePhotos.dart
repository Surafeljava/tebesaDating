  ...
  Future<bool> getImage(ImageSource src) async {
    ...
    if (pickedFile != null) {
      if(photos.length>clickedIndex){
        ...
        String name = FirebaseAuth.instance.currentUser.uid.toString() + clickedIndex.toString();
        String url = await _databaseService.uploadOnePhoto(File(pickedFile.path), name);
        setState(() {
