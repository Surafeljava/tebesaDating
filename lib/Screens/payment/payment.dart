...
class _PaymentState extends State<Payment> {
  ...
  List<BankDetail> availableBanks = [];
  bool availableBanksChecked = false;
  ...
  void initState() {
    super.initState();
    databaseService.getAllPaymentOptions().then((value) {
      print("** Total banks vailable: ${value.length}");
      setState(() {
        availableBanks = value;
        availableBanksChecked = true;
      });
    });
  }
          ...
          child: ListView(
            ...
            children: [
              ...
              Container(
                ...
                child: availableBanksChecked
                    ? availableBanks.isNotEmpty
                        ? GridView.builder(
                            gridDelegate:
                            ...
                            itemBuilder: (BuildContext ctx, index) {
                              return BankChooseCard(
                                ...
                                bankDetail: availableBanks[index],
                  ...
                  onTap: () async {
                    ...
                    if (_formKey.currentState.validate()) {
                      ...
                      PaymentModel pModel = new PaymentModel(
                          ...
                          acceptedDate: null,
                          bank: availableBanks[selected].name,
                          date: DateTime.now(),
                          transactionRef: "",
                          packageMonth: 2,
                          status: 0,
